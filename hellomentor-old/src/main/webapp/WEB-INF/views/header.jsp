...
<head>
    ...
    <title>Header</title>
    <!-- header 스타일 -->
    <link href="${pageContext.request.contextPath}/resources/css/header-style.css" rel="stylesheet"/>
    <!-- Pretendard 폰트 cdn -->
...
<header>
    <div class="header-wrap">
        <div class="logo-container">
            <!-- logo 클릭시 로그인 페이지로 이동(href 주소 넣어주기!!) -->
            <img
                    class="logo-img"
        ...
        <div class="navi">
            <div class="menubar">
                <!-- 클릭시 로그인 전에는 이용이 불가능하다는 alert 메세지 띄우고 로그인페이지로 이동-->
                <a href="" class="menu">자유게시판</a>
                <a href="" class="menu">지식인</a>
                <a href="" class="menu">멘토링</a>
                <a href="" class="menu">스터디</a>
            </div>
            <div class="login-box">
                <!-- 로그인, 회원가입 페이지 href 주소 넣어주기 -->
                <a href="" id="login">로그인</a>
                <a href="" id="signIn">회원가입</a>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="header-wrap">
        ...
        <div class="navi">
            ...
            <div class="profile-bar">
                <!-- 마이페이지의 alarm페이지로 이동 -->
                <div id="alarm" onclick="location.href=''">
                    <svg
                    ...
                    <!-- 빨간점은 alarm이 있을때만 보여지게 하기 -->
                    <div class="red-dot"></div>
                </div>
                <!-- 메세지 목록 페이지로 이동 -->
                <div id="messenger" onclick="location.href=''">
                    <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="35"
                            height="32"
                ...
                <div id="profile-container">
                    ...
                    <!-- 프로필 이미지 클릭시 마이페이지로 이동 -->
                    <div
                            id="profile"
                            style="background-image: url(../resources/img/profile-img.jpeg)"
                            onclick="location.href=''"
                    ></div>
